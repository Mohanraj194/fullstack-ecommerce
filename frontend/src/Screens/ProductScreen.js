                            ...
                            <Col md={3}>
                                <Card>
                                    <ListGroup>
                                        ...
                                        <ListGroup.Item>
                                            <Button variant="dark" className="btn-block" type="button" disabled={product.countInStock === 0} onClick={addToCartHandler}>
                                                ADD To CART
                                            </Button>
                                        </ListGroup.Item>
                                    </ListGroup>
                            ...
                            <Col md={6}>
                                ...
                                <ListGroup variant='flush'>
                                    ...
                                    <ListGroup.Item>
                                        ...
                                        {successProductReviewCreate && (<Message variant='success'> Review submitted successfully</Message>)}
                                        {loadingProductReviewCreate && <Loader />}
                                        {errorProductReviewCreate && <Message variant='danger'>{errorProductReviewCreate}</Message>}
                                        {userInfo ? (
